...
> Since AstroPaper v1.4.0, OG images will be generated automatically if not specified. Check out [the announcement](https://astro-paper.pages.dev/p/dynamic-og-image-generation-in-astropaper-blog-posts/).
